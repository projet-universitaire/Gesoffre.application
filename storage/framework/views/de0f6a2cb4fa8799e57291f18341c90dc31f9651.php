...
<ul class="nav sidebar-menu">
    ...
    <li>
        ...
        <ul class="nav sub-nav">
            <li <?php echo e((current_page("list-sponsors")) ? 'class=active' : ''); ?>>
                <a href="<?php echo e(url('/list-sponsors')); ?>">
                    <span class="fa fa-cube"></span> List Sponsors</a>
            </li>
            <li <?php echo e((current_page("create-sponsors")) ? 'class=active' : ''); ?>>
                <a href="<?php echo e(url('/create-sponsors')); ?>">
    ...
    <li>
        ...
        <ul class="nav sub-nav">
            <li <?php echo e((current_page("Categorie-list")) ? 'class=active' : ''); ?>>
                <a href="<?php echo e(url('Categorie-list')); ?>">
                    <span class="fa fa-cube"></span> List Categories</a>
            </li>
            <li <?php echo e((current_page("Categorie-create")) ? 'class=active' : ''); ?>>
                <a href="<?php echo e(url('Categorie-create')); ?>">
