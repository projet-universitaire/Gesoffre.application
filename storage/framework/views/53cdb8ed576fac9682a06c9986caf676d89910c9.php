...
<!-- Mirrored from admindesigns.com/demos/absolute/1.1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jun 2015 11:50:08 GMT -->
<head>
  ...
  <!-- Font CSS (Via CDN) -->
  <link rel='stylesheet' type='text/css' href="<?php echo e(asset('http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700')); ?>">

  <!-- FullCalendar Plugin CSS -->
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/plugins/fullcalendar/fullcalendar.min.css')); ?>">

  <!-- Theme CSS -->
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/skin/default_skin/css/theme.css')); ?>">

  <!-- Admin Forms CSS -->
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/admin-tools/admin-forms/css/admin-forms.min.css')); ?>">
  ...
  <script src="<?php echo e(asset('https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js')); ?>"></script>
<![endif]-->
...
--------------------------------------------------------------->
      ...
      <ul class="nav navbar-nav navbar-right">
                    ...
                    <div class="tab-content br-n pn">
                      ...
                      <div id="nav-tab2" class="tab-pane chat-widget" role="tabpanel">
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" alt="64x64" src="<?php echo e(asset('assets/img/avatars/3.jpg')); ?>">
                            </a>
                          </div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          ...
                          <div class="media-right">
                            <a href="#">
                              <img class="media-object" alt="64x64" src="<?php echo e(asset('assets/img/avatars/1.jpg')); ?>">
                            </a>
                          </div>
                        </div>
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" alt="64x64" src="<?php echo e(asset('assets/img/avatars/2.jpg')); ?>">
                            </a>
                          </div>
                          <div class="media-body">
                            <span class="media-status online"></span>
                      ...
                      <div id="nav-tab3" class="tab-pane scroller-nm" role="tabpanel">
                        <ul class="media-list" role="menu">
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?php echo e(asset('assets/img/avatars/5.jpg')); ?>" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?php echo e(asset('assets/img/avatars/2.jpg')); ?>" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?php echo e(asset('assets/img/avatars/3.jpg')); ?>" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?php echo e(asset('assets/img/avatars/4.jpg')); ?>" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading mv5">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
        ...
        <li class="dropdown menu-merge">
          <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
          	<img src="<?php echo e(asset('assets/img/avatars/1.jpg')); ?>" alt="avatar" class="mw30 br64">
          ...
          <div class="sidebar-widget author-widget">
            <div class="media">
              <a class="media-left" href="#">
                <img src="<?php echo e(asset('assets/img/avatars/3.jpg')); ?>" class="img-responsive">
              </a>
              <div class="media-body">
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo e(route('form')); ?>">
                  <span class="glyphicon glyphicon-shopping-cart"></span> Admin Elements  nice </a>
              </li>
              <li>
  ...
  <script src="<?php echo e(asset('vendor/plugins/tabdrop/bootstrap-tabdrop.js')); ?>"></script>

  <!-- FullCalendar Plugin + moment Dependency -->
  <script src="<?php echo e(asset('vendor/plugins/fullcalendar/lib/moment.min.js')); ?>"></script>
  <script src="<?php echo e(asset('vendor/plugins/fullcalendar/fullcalendar.min.js')); ?>"></script>
...
<!-- Mirrored from admindesigns.com/demos/absolute/1.1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Jun 2015 11:50:09 GMT -->
</html>
