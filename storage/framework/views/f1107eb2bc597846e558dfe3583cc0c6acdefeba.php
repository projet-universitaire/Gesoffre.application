...
<header class="navbar navbar-fixed-top navbar-shadow">
    <div class="navbar-branding">
        <a class="navbar-brand" href="">
            <b> <span class="glyphicon glyphicon-home"></span> Smarty &copy</b>
        </a>
    ...
    <ul class="nav navbar-nav navbar-right">
                            ...
                            <div class="tab-content br-n pn">
                                ...
                                <div id="nav-tab2" class="tab-pane chat-widget" role="tabpanel">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#">
                                                <img class="media-object" alt="64x64" src="<?php echo e(asset('assets/img/avatars/.jpg')); ?>">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div id="nav-tab3" class="tab-pane scroller-nm" role="tabpanel">
                                    <ul class="media-list" role="menu">
                                        ...
                                        <li class="media">
                                            <a class="media-left" href="#"> <img src="<?php echo e(asset('assets/img/avatars/.jpg')); ?>" class="mw40" alt="avatar"> </a>
                                            <div class="media-body">
                                                <h5 class="media-heading">Article
                                                    <small class="text-muted">- 08/16/22</small>
                                                </h5> Last Updated 36 days ago by
        ...
        <li class="dropdown menu-merge">
            <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                <img src="<?php echo e(asset('assets/img/avatars/.jpg')); ?>" alt="avatar" class="mw30 br64">
                    ...
                    <div class="pull-right mr10">
                        <select id="user-role">
                            <optgroup label="Logged in As:">
                                ...
                                <option value="1-3" selected="selected">Superadmin</option>
                            </optgroup>
                        </select>
                    </div>
